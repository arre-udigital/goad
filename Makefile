...
LDFLAGS = -ldflags "-X=github.com/ujwalparker/goad/version.version=$(VERSION) -X=github.com/ujwalparker/goad/version.build=$(BUILD) -X=github.com/ujwalparker/goad/version.travisTag=$(TRAVIS_TAG)"
